...
Blockly.JavaScript['arduino_servo_attach'] = function(block) {
  var text_pin = block.getFieldValue('pin');
...
Blockly.JavaScript['arduino_servo_detach'] = function(block) {
  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
...
Blockly.JavaScript['arduino_servo_write_micros'] = function(block) {
  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
  var value_degree = Blockly.JavaScript.valueToCode(block, 'degree', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['arduino_servo_read'] = function(block) {
  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
  var code = `${variable_instance}.read()`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['arduino_servo_read_micros'] = function(block) {
  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
